...
import {ERC721Bridge} from "contracts/universal/ERC721Bridge.sol";
import {IERC721} from "@openzeppelin/contracts/token/ERC721/IERC721.sol";
import {L2ERC721Bridge} from "contracts/L2/L2ERC721Bridge.sol";
...
contract L1ERC721Bridge is ERC721Bridge, ISemver {
    ...
    function initialize(CrossDomainMessenger _messenger, SuperchainConfig _superchainConfig) public initializer {
        ...
        __ERC721Bridge_init({_messenger: _messenger, _otherBridge: StandardBridge(payable(Predeploys.L2_ERC721_BRIDGE))});
    }
