...
export interface CrossDomainOwnable2_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_revertNotSetOnlyOwner()": FunctionFragment;
    "test_revertNotSetOnlyOwner2()": FunctionFragment;
    "test_revertOnlyOwner()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_onlyOwner"
      | "test_revertNotSetOnlyOwner"
      | "test_revertNotSetOnlyOwner2"
      | "test_revertOnlyOwner"
      | "tip"
      | "vm"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_revertNotSetOnlyOwner",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_revertNotSetOnlyOwner2",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_revertOnlyOwner",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CrossDomainOwnable2_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrossDomainOwnable2_TestInterface;
  ...
  callStatic: {
    ...
    test_revertNotSetOnlyOwner(overrides?: CallOverrides): Promise<void>;

    test_revertNotSetOnlyOwner2(overrides?: CallOverrides): Promise<void>;

    test_revertOnlyOwner(overrides?: CallOverrides): Promise<void>;
