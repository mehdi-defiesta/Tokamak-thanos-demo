...
export interface AddressAliasHelper_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_fuzz_roundtrip(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_fuzz_roundtrip",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface AddressAliasHelper_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AddressAliasHelper_TestInterface;
