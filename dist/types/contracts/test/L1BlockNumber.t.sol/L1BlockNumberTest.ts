...
export interface L1BlockNumberTestInterface extends utils.Interface {
  functions: {
    ...
    "test_fallback()": FunctionFragment;
    "test_getL1BlockNumber()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_fallback",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_getL1BlockNumber",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1BlockNumberTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1BlockNumberTestInterface;
  ...
  callStatic: {
    ...
    test_fallback(overrides?: CallOverrides): Promise<void>;

    test_getL1BlockNumber(overrides?: CallOverrides): Promise<void>;
