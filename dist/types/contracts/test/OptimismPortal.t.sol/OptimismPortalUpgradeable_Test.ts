...
export interface OptimismPortalUpgradeable_TestInterface
  ...
  functions: {
    ...
    "test_cannotInitImpl()": FunctionFragment;
    "test_cannotInitProxy()": FunctionFragment;
    "test_initValuesOnProxy()": FunctionFragment;
    "test_upgrading()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_cannotInitImpl",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_cannotInitProxy",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initValuesOnProxy",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_upgrading",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismPortalUpgradeable_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_cannotInitImpl(overrides?: CallOverrides): Promise<void>;

    test_cannotInitProxy(overrides?: CallOverrides): Promise<void>;

    test_initValuesOnProxy(overrides?: CallOverrides): Promise<void>;

    test_upgrading(overrides?: CallOverrides): Promise<void>;
