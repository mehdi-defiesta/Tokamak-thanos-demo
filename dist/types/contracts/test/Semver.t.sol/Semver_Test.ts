...
export interface Semver_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_behindProxy()": FunctionFragment;
    "test_version()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_behindProxy",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_version",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Semver_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Semver_TestInterface;
  ...
  callStatic: {
    ...
    test_behindProxy(overrides?: CallOverrides): Promise<void>;

    test_version(overrides?: CallOverrides): Promise<void>;
