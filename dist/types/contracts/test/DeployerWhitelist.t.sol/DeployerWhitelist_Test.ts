...
export interface DeployerWhitelist_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_storageSlots()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_storageSlots",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DeployerWhitelist_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployerWhitelist_TestInterface;
  ...
  callStatic: {
    ...
    test_storageSlots(overrides?: CallOverrides): Promise<void>;
