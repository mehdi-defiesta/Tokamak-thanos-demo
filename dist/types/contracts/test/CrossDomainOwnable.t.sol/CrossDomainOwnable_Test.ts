...
export interface CrossDomainOwnable_TestInterface extends utils.Interface {
  functions: {
...
export interface CrossDomainOwnable_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrossDomainOwnable_TestInterface;
