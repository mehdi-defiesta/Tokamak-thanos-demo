...
export interface CrossDomainOwnableThroughPortal_TestInterface
  ...
  functions: {
    ...
    "test_depositTransaction_crossDomainOwner()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_depositTransaction_crossDomainOwner"
      | "tip"
      | "vm"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositTransaction_crossDomainOwner",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CrossDomainOwnableThroughPortal_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrossDomainOwnableThroughPortal_TestInterface;
