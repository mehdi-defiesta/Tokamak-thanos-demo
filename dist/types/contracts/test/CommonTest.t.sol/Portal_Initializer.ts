...
export interface Portal_InitializerInterface extends utils.Interface {
  functions: {
...
export interface Portal_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Portal_InitializerInterface;
