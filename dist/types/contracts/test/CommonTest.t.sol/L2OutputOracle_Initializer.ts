...
export interface L2OutputOracle_InitializerInterface extends utils.Interface {
  functions: {
...
export interface L2OutputOracle_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2OutputOracle_InitializerInterface;
