...
export interface LegacyMessagePasser_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_LegacyMessagePasser_passMessageToL1_Succeeds()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_LegacyMessagePasser_passMessageToL1_Succeeds"
      | "tip"
      | "vm"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_LegacyMessagePasser_passMessageToL1_Succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface LegacyMessagePasser_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LegacyMessagePasser_TestInterface;
