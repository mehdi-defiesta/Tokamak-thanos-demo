...
export interface OptimismMintableTokenFactory_TestInterface
  ...
  functions: {
    ...
    "test_createStandardL2Token()": FunctionFragment;
    "test_createStandardL2TokenSameTwice()": FunctionFragment;
    "test_createStandardL2TokenShouldRevertIfRemoteIsZero()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_bridge"
      | "test_createStandardL2Token"
      | "test_createStandardL2TokenSameTwice"
      | "test_createStandardL2TokenShouldRevertIfRemoteIsZero"
      | "tip"
      | "vm"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_createStandardL2Token",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_createStandardL2TokenSameTwice",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_createStandardL2TokenShouldRevertIfRemoteIsZero",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismMintableTokenFactory_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_createStandardL2Token(overrides?: CallOverrides): Promise<void>;
