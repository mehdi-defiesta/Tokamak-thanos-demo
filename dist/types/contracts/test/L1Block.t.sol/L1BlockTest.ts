...
export interface L1BlockTestInterface extends utils.Interface {
  functions: {
    ...
    "test_hash()": FunctionFragment;
    "test_number()": FunctionFragment;
    "test_sequenceNumber()": FunctionFragment;
    "test_timestamp()": FunctionFragment;
    "test_updateValues()": FunctionFragment;
    "test_updatesValues(uint64,uint64,uint256,bytes32,uint64)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "test_hash", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "test_number",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_sequenceNumber",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_timestamp",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_updateValues",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_updatesValues",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  decodeFunctionResult(functionFragment: "test_hash", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "test_number",
    data: BytesLike
  ): Result;
...
export interface L1BlockTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1BlockTestInterface;
  ...
  callStatic: {
    ...
    test_hash(overrides?: CallOverrides): Promise<void>;

    test_number(overrides?: CallOverrides): Promise<void>;

    test_sequenceNumber(overrides?: CallOverrides): Promise<void>;

    test_timestamp(overrides?: CallOverrides): Promise<void>;

    test_updateValues(overrides?: CallOverrides): Promise<void>;
