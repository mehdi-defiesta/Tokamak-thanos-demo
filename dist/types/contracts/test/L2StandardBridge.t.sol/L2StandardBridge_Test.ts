...
export interface L2StandardBridge_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_cannotWithdrawEthWithoutSendingIt()": FunctionFragment;
    ...
    "test_finalizeDeposit()": FunctionFragment;
    "test_initialize()": FunctionFragment;
    "test_receive()": FunctionFragment;
    "test_withdraw()": FunctionFragment;
    "test_withdrawTo()": FunctionFragment;
    "test_withdraw_onlyEOA()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_cannotWithdrawEthWithoutSendingIt"
  ...
  encodeFunctionData(
    functionFragment: "test_cannotWithdrawEthWithoutSendingIt",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeDeposit",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_withdrawTo",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_withdraw_onlyEOA",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2StandardBridge_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2StandardBridge_TestInterface;
  ...
  callStatic: {
    ...
    test_finalizeDeposit(overrides?: CallOverrides): Promise<void>;
    ...
    test_withdrawTo(overrides?: CallOverrides): Promise<void>;

    test_withdraw_onlyEOA(overrides?: CallOverrides): Promise<void>;
