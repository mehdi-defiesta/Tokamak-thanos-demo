...
export interface L2ToL1MessagePasserTestInterface extends utils.Interface {
  functions: {
    ...
    "test_fuzz_initiateWithdrawal(address,address,uint256,uint256,bytes)": FunctionFragment;
    "test_initiateWithdrawal_fromContract()": FunctionFragment;
    "test_initiateWithdrawal_fromEOA()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_burn"
      | "test_fuzz_initiateWithdrawal"
      | "test_initiateWithdrawal_fromContract"
  ...
  encodeFunctionData(
    functionFragment: "test_fuzz_initiateWithdrawal",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "test_initiateWithdrawal_fromContract",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initiateWithdrawal_fromEOA",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2ToL1MessagePasserTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2ToL1MessagePasserTestInterface;
  ...
  callStatic: {
    ...
    test_initiateWithdrawal_fromEOA(overrides?: CallOverrides): Promise<void>;
