...
export interface GasBenchMark_L1StandardBridge_DepositInterface
  ...
  functions: {
    ...
    "test_depositERC20_benchmark_0()": FunctionFragment;
    "test_depositERC20_benchmark_1()": FunctionFragment;
    "test_depositETH_benchmark_0()": FunctionFragment;
    "test_depositETH_benchmark_1()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositERC20_benchmark_0",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositERC20_benchmark_1",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositETH_benchmark_0",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_depositETH_benchmark_1",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GasBenchMark_L1StandardBridge_Deposit extends BaseContract {
  ...
  callStatic: {
    ...
    test_depositERC20_benchmark_0(overrides?: CallOverrides): Promise<void>;

    test_depositERC20_benchmark_1(overrides?: CallOverrides): Promise<void>;

    test_depositETH_benchmark_0(overrides?: CallOverrides): Promise<void>;

    test_depositETH_benchmark_1(overrides?: CallOverrides): Promise<void>;
