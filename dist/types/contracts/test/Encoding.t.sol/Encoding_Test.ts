...
export interface Encoding_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_decodeVersionedNonce_differential(uint240,uint16)": FunctionFragment;
    "test_encodeCrossDomainMessage_differential(uint240,uint8,address,address,uint256,uint256,bytes)": FunctionFragment;
    "test_encodeDepositTransaction_differential(address,address,uint256,uint256,uint64,bool,bytes,uint256)": FunctionFragment;
    "test_nonceVersioning(uint240,uint16)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_decodeVersionedNonce_differential"
      | "test_encodeCrossDomainMessage_differential"
      | "test_encodeDepositTransaction_differential"
      | "test_nonceVersioning"
      | "tip"
      | "vm"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_decodeVersionedNonce_differential",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "test_encodeCrossDomainMessage_differential",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "test_encodeDepositTransaction_differential",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "test_nonceVersioning",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface Encoding_Test extends BaseContract {
  ...
  functions: {
    ...
    test_encodeDepositTransaction_differential(
      ...
      isCreate: PromiseOrValue<boolean>,
      _data: PromiseOrValue<BytesLike>,
