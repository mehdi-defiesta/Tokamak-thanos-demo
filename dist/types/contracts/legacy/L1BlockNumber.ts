...
export interface L1BlockNumberInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getL1BlockNumber" | "version"
  ): FunctionFragment;
...
export interface L1BlockNumber extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1BlockNumberInterface;
